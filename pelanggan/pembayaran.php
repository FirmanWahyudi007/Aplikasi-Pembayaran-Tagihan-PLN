								...
								<div class="block-content">
									<form action="insert-pembayaran.php" method="post">
                                        <?php 
                                            $id = $_GET['id'];
                                            $administrasi = "2500";
                                            $pem = mysqli_query($koneksi,"SELECT p.nama,p.id_pelanggan,t.id_tagihan,t.tgl_tagihan,t.tagihan FROM tb_tagihan t JOIN tb_pelanggan p ON t.id_pelanggan=p.id_pelanggan WHERE id_tagihan = $id");
                                            while ($data = mysqli_fetch_array($pem)) {
                                         ?>
										<div class="form-group row">
                                            <label class="col-12" for="id_tagihan">ID Tagihan</label>
                                            <div class="col-md-6">
                                                <input class="form-control" type="text" name="id_tagihan" value="<?php echo $id ?>">
                                            </div>
                                        </div>
										<div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                $administrasi ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-12" for="total">Total</label>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" name="total" value="<?php echo $data['tagihan'] + $administrasi ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row">
